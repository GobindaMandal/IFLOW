        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-4 ">
                        <h6 class="inline1">{{ $report->supp_code }}<h6 class="inline"> {{ $report->supp_name }}</h6></h6>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border">{{ $details->quantity_received }}</td>
                                    <td class="border">{{ $details->quantity_accepted }}</td>
                                    <td class="border">{{ $details->unit_code }}</td>
                                    <td class="border">{{ $details->rate }}</td>
                                    <td class="border">{{ $details->amount_accepted }}</td>
                            ...
                            <tfoot >
                                <tr class="tfooter">
                                    ...
                                    <th class="border">{{ $t_amnt->total_amount }}</th>
                                    @endforeach
